...
function showLoginForm() {
    ...
    document.getElementById('mainContent').style.display = 'none'; // Fixed: Use mainContent ID
}

function showMainContent() {
    document.getElementById('loginContainer').style.display = 'none';
    document.getElementById('mainContent').style.display = 'block'; // Fixed: Use mainContent ID
}
